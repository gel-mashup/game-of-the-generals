...
plan: '05'
subsystem: game
tags: [socket.io, battle, game-engine, real-time]

# Dependency graph
requires:
  - phase: 02-game-core
    provides: BattleOutcome type, move:result socket event, BattleReveal component
provides:
...
affects: [02-game-core, 03-game-flow]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - Socket event augmentation (server adds payload fields without breaking clients)
    - Client-side type transformation (server type → client type mapping)
