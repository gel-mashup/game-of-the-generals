...
- [x] **DEP-02**: User can only place pieces in their deployment zone ✓ (enforced, checkbox missed during YOLO development)
...
- [x] **GAME-04**: User can move piece to adjacent orthogonal square ✓ (implemented, checkbox missed during YOLO development)
- [x] **GAME-05**: User cannot move to square occupied by own piece ✓ (enforced, checkbox missed during YOLO development)
- [x] **GAME-06**: Battle occurs when moving to occupied square ✓
- [x] **GAME-07**: Higher rank wins; equal rank = both eliminated ✓
- [x] **GAME-08**: Spy beats all officers (rank 0+) ✓ (implemented, checkbox missed during YOLO development)
- [x] **GAME-09**: Private beats Spy ✓ (implemented, checkbox missed during YOLO development)
- [x] **GAME-10**: Flag captured by any piece ✓ (implemented, checkbox missed during YOLO development)
...
*Archived from .planning/REQUIREMENTS.md on 2026-03-20*
